...
public class RiverScan {
    public static void main(String[] args){
        ...
        for(int i = 0; i< water.length; i++) {
            ...
            System.out.print ( " Площа " + ( i + 1 ) + " - ї річки = > " ) ;
            water[i].length = sc.nextDouble() ;
        }

        shortRiver(water);// 1. Визначити найкоротшу річку;
        averageLength(water);//2. Вивести інформацію про річки з довжиною більшою за середню;
        sortingRiver(water);// 3. Упорядкувати список річок за назвами за абеткою;
        renameInfo(sc,water);// 4.Організувати пошук за назвою річки, виправлення одного з полів та виведення повної інформації про річку після редагування.
    }
    private static void shortRiver(River[] water){
    ...
    private static void averageLength(River[] water){
    ...
    private static void sortingRiver(River[] water){
    ...
    private static void renameInfo(Scanner sc,River[] water){
        System.out.print("\nВведіть назву річки => ");
        sc.nextLine();
